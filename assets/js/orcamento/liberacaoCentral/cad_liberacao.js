    ...
    $('body').on('click', '.btn-add', function (e) {
        ...
        if (e.isDefaultPrevented()) {
            ...
            var Dados = {
                ...
                valor: $("#valor").val(),
                obs_liberacao: $("#obs_liberacao").val()
            }
            ...
            var linha = "<tr class='linhas' \n\
                            ...
                            fonte='" + Dados.fonte + "'\n\
                            valor='" + Dados.valor + "'\n\
                            obs_liberacao='" + Dados.obs_liberacao + "'>\n\
                            <td>" + Texto.central + "</td>\n\
                            <td>" + Texto.projeto + "</td>\n\
        ...
        if (e.isDefaultPrevented()) {
            ...
            $(".linhas").each(function (index) {
                Dados.push({
                    ...
                    obs_liberacao: $(this).attr('obs_liberacao')
                });
            });
