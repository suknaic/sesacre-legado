$(document).ready(function () {
    ...
    function listaPPAProg() {
        $.ajax({
            "url": "/model/pla/ppa_prog/request.php",
            "dataType": 'html',
            "data": {
                acao: "listaPpaProgTable"
            },
    ...
    $('body').on('click', '.btn-salvar', function (e) {
        ...
        if (e.isDefaultPrevented()) {
            ...
            if ( Dados.nome == "" || Dados.dt_inicio == "" || Dados.dt_fim == ""
                    || Dados.dt_inicio.length != 4 || Dados.dt_fim.length != 4 
                    || Dados.codigo == "") {
    ...
    $('body').on('keypress', '.formPPAProg', function (e) {
        var key = e.which;
        if (key == 13) {
