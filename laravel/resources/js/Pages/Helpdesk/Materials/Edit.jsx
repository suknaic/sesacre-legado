...
export default function Edit({ material }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        ram_memory: material.ram_memory ?? '',
        processor: material.processor ?? '',
        hd_size: material.hd_size ?? '',
        has_wireless: material.has_wireless ?? false,
    });
    ...
    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Material</h2>
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700">Patrimônio</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700">Nº Serial</label>
                                    <input
                                        type="text"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        value={data.ram_memory}
                                        onChange={(e) => setData('ram_memory', e.target.value)}
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700">HD (GB)</label>
                                    <input
                                        type="number"
                                        value={data.hd_size}
                                        onChange={(e) => setData('hd_size', e.target.value)}
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700">Processador</label>
                                    <input
                                        type="text"
                                ...
                                <div className="flex items-center pt-6">
                                    <label className="flex items-center gap-2">
                                        <input
                                            type="checkbox"
                                            checked={data.has_wireless}
                                            onChange={(e) => setData('has_wireless', e.target.checked)}
                                            className="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500"
                                        />
                                        <span className="text-sm text-gray-700">Possui Wireless</span>
                                    </label>
                                </div>
                            </div>
