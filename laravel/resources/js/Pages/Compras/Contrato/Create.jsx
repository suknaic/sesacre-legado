...
export default function Create({ fornecedores, programasTrabalho, fontes, modalidades, tiposGasto, pessoas, lotacoes }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        ds_obs_contrato: '',
        ds_area_abrangencia: '',
        ds_unidade_contemplada: '',
        fl_servico_continuado: false,
        fl_carona: false,
        id_pessoa_gestor_titular: '',
        id_pessoa_gestor_substituto: '',
        id_pessoa_fiscal_titular: '',
        id_pessoa_fiscal_substituto: '',
        id_pessoa_sub_fiscal_titular: '',
        id_pessoa_sub_fiscal_substituto: '',
        id_lotacao_central: '',
    });

    function handleSubmit(e) {
        e.preventDefault();
        post(route('compras.contratos.store'));
    }

    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Novo Contrato</h2>}>
                ...
                <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <form onSubmit={handleSubmit} className="p-6">
                        ...
                        <div className="flex items-center justify-end gap-4 mt-6">
                            <Link href={route('compras.contratos.index')} className="rounded-md bg-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-300">Cancelar</Link>
