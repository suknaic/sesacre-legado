...
export default function Edit({ decreeValue, decreeTypes, travelClasses }) {
    const { data, setData, put, processing, errors } = useForm({
        decree_type_id: decreeValue.decree_type_id || '',
        travel_class_id: decreeValue.travel_class_id || '',
        value: decreeValue.value || '',
        is_active: decreeValue.is_active ?? true,
    });

    function handleSubmit(e) {
        e.preventDefault();
        put(route('decree-values.update', decreeValue.id));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Valor de Diária</h2>
            ...
            <Head title="Editar Valor de Diária" />
            <div className="py-8">
