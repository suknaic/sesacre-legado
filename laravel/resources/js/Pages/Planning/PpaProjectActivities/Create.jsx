...
export default function Create({ strategicPlans }) {
    const { data, setData, post, processing, errors } = useForm({
        strategic_plan_id: '', code: '', name: '', type: 'P', is_active: true,
    });

    function handleSubmit(e) {
        e.preventDefault();
        post(route('ppa-project-activities.store'));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Novo Projeto/Atividade</h2>
            ...
            <Head title="Novo Projeto/Atividade" />
            <div className="py-8">
