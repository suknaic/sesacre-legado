...
export default function Edit({ budgetProposal }) {
    const { data, setData, put, processing, errors } = useForm({
        year: budgetProposal.year,
        situation: budgetProposal.situation || '',
        is_active: budgetProposal.is_active,
    });

    function handleSubmit(e) {
        e.preventDefault();
        put(route('budget-proposals.update', budgetProposal.id));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Proposta Orçamentária</h2>
            ...
            <Head title="Editar Proposta Orçamentária" />
            <div className="py-8">
