...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({
        name: '', indicator: '', goal: '', registration_type: '', is_active: true,
    });

    function handleSubmit(e) {
        e.preventDefault();
        post(route('plan-objectives.store'));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Novo Objetivo</h2>
