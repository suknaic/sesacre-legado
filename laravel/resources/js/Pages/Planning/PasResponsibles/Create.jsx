...
export default function Create({ people, organizations }) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(route('pas-responsibles.store'));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Novo Responsável PAS</h2>
            ...
            <Head title="Novo Responsável PAS" />
            <div className="py-8">
