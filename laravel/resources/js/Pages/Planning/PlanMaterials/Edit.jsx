...
export default function Edit({ planMaterial }) {
    const { data, setData, put, processing, errors } = useForm({
        code: planMaterial.code || '',
        name: planMaterial.name || '',
        description_code: planMaterial.description_code || '',
        description_name: planMaterial.description_name || '',
        group_code: planMaterial.group_code || '',
        group_name: planMaterial.group_name || '',
        subgroup_code: planMaterial.subgroup_code || '',
        subgroup_name: planMaterial.subgroup_name || '',
        material_type: planMaterial.material_type || '',
        expense_element_code: planMaterial.expense_element_code || '',
        expense_type_id: planMaterial.expense_type_id || '',
    });

    function handleSubmit(e) {
        e.preventDefault();
        put(route('plan-materials.update', planMaterial.id));
    }
