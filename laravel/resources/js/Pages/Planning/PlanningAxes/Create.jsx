...
export default function Create({ pesPlans }) {
    const { data, setData, post, processing, errors } = useForm({
        pes_plan_id: '', name: '', order: '0', is_active: true,
    });

    function handleSubmit(e) {
        e.preventDefault();
        post(route('planning-axes.store'));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Novo Eixo</h2>
