...
export default function Edit({ execution, budgetProposals, planActions }) {
    const { data, setData, put, processing, errors } = useForm({
        budget_proposal_id: execution.budget_proposal_id?.toString() || '',
        plan_action_id: execution.plan_action_id?.toString() || '',
    ...
    function handleSubmit(e) {
        e.preventDefault();
        put(route('budget-execution.update', execution.id));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Execução Orçamentária</h2>
            ...
            <Head title="Editar Execução Orçamentária" />
            <div className="py-8">
