...
export default function Create({ axes }) {
    const { data, setData, post, processing, errors } = useForm({
        planning_axis_id: '', name: '', order: '0', is_active: true,
    });

    function handleSubmit(e) {
        e.preventDefault();
        post(route('planning-guidelines.store'));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Nova Diretriz</h2>
