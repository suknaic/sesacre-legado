...
export default function Create({ annualPlans, planActions, ppaProjectActivities }) {
    const { data, setData, post, processing, errors } = useForm({
        annual_plan_id: '', plan_action_id: '', ppa_project_activity_id: '',
        partnership_desc: '', programming_goal: '', programming_indicator: '', is_active: true,
    });

    function handleSubmit(e) {
        e.preventDefault();
        post(route('pas-actions.store'));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Nova Ação do PAS</h2>
