...
export default function Edit({ validation, annualPlans }) {
    const { data, setData, put, processing, errors } = useForm({
        annual_plan_id: validation.annual_plan_id?.toString() || '',
        validation_status: validation.validation_status?.toString() || '1',
        description: validation.description || '',
    });

    function handleSubmit(e) {
        e.preventDefault();
        put(route('pas-validations.update', validation.id));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Validação do PAS</h2>
            ...
            <Head title="Editar Validação do PAS" />
            <div className="py-8">
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-900">{statusLabels[validation.validation_status]}</p>
