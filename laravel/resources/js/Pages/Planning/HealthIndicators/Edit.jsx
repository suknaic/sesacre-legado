...
export default function Edit({ indicator }) {
    const { data, setData, put, processing, errors } = useForm({
        name: indicator.name || '',
        year: indicator.year?.toString() || '',
        note_code: indicator.note_code || '',
    ...
    function handleSubmit(e) {
        e.preventDefault();
        put(route('health-indicators.update', indicator.id));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Indicador de Saúde</h2>
            ...
            <Head title="Editar Indicador de Saúde" />
            <div className="py-8">
