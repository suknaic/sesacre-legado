...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({ name: '', is_active: true });

    function handleSubmit(e) {
        e.preventDefault();
        post(route('education-levels.store'));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Novo Nível de Escolaridade</h2>
            ...
            <Head title="Novo Nível de Escolaridade" />
            <div className="py-8">
