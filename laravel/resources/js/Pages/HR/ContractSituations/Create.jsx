...
export default function Create() {
    ...
    function handleSubmit(e) { e.preventDefault(); post(route('contract-situations.store')); }

    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Nova Situação Contratual</h2>}>
            <Head title="Nova Situação" />
