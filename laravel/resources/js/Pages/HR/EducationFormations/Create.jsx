...
export default function Create({ educationLevels }) {
    const { data, setData, post, processing, errors } = useForm({ name: '', education_level_id: '', is_active: true });

    function handleSubmit(e) {
        e.preventDefault();
        post(route('education-formations.store'));
    }

    return (
        <AuthenticatedLayout header={
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Novo Curso</h2>
