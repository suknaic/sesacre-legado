...
export default function Create({ tipos, pedidos, lotacoes }) {
    ...
    const precisaLotacao = data.st_nivel && tipos[data.st_nivel]?.lotacao;

    function handleSubmit(e) {
        e.preventDefault();
        post(route('financeiro.autorizacoes.store'));
    }

    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Nova Autorização</h2>}>
            <Head title="Nova Autorização" />
                ...
                <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <form onSubmit={handleSubmit} className="p-6">
                        ...
                        <div className="flex items-center justify-end gap-4">
                            <Link href={route('financeiro.autorizacoes.index')} className="rounded-md bg-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-300">Cancelar</Link>
