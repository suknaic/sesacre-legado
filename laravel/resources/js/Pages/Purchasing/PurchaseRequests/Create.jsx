...
export default function Create({ suppliers, situations }) {
                ...
                <div className="mx-auto max-w-3xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6">
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700" htmlFor="supplier_id">
                                    Fornecedor
                                </label>
                                <select
                                    id="supplier_id"
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700" htmlFor="purchase_request_situation_id">
                                    Situação
                                </label>
                                <select
                                    id="purchase_request_situation_id"
                                    value={data.purchase_request_situation_id}
                                    onChange={(e) => setData('purchase_request_situation_id', e.target.value)}
                                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                >
                                    <option value="">Selecione...</option>
                                    {situations.map((s) => (
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700" htmlFor="request_date">
                                    Data do Pedido
                                </label>
                                <input
                                    id="request_date"
