...
const menuItems = [
    ...
    },
    {
        ...
        children: [
            ...
            { label: 'PES', route: '/page/pes' },
            { label: 'Programa Setorial', route: '/page/programa-setorial' },
    ...
    },
    {
        ...
        children: [
            ...
            { label: 'Materiais', route: '/page/chamados-materiais' },
        ],
    },
    {
        label: 'Orçamento',
        ...
        children: [
            ...
            { label: 'Autorizações', route: '/page/diarias-autorizacoes' },
            {
                ...
                children: [
                    ...
                    { label: 'Valores das Diárias', route: '/page/diarias-valores' },
