<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/ppa_prog/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Programa do PPA</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formPPAProg">
                        ...
                        <!-- Fim Form -->
                         ...
                         <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Programa do PPA</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/assets/js/pla/ppa_prog/index.js"></script>
