<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/pta/acao_det.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Detalhamento das Ações - <?php echo $ptaTitulo->getNmPtaTitulo(); ?></h1>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="panel ">
                                    ...
                                    <form class="form-horizontal form">
                                        ...
                                        <input type="hidden" name="pta" id="pta" value="<?php echo $ptaTitulo->getIdPta(); ?>" />
                                                ...
                                                <div id="form-1" class="tab-pane fade active in">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel-body">
                                                                <label for="nome">
                                                                    Nome do Detalhamento da Ação: <span class="text-danger">*</span>
                                                                </label>
        ...
        <script src="/assets/js/pla/pta/acao_det.js"></script>
