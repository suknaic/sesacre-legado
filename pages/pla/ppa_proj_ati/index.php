<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/ppa_proj_ati/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Projeto/Atividade do PPA - <?php echo $nomePpaProg; ?></h1>                     
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    
                    <ol class="breadcrumb">
                        <li><a href="../ppa_prog/">Programa do PPA</a></li>
                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formPPAProjAti">
                                        <input  type="hidden" id="ppa_prog" name="ppa_prog" value="<?php echo $idPpaProg; ?>" />                                        
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5" >
                                                    <div class="panel-body">
                                                        <label for="">Projeto/Atividade: <span class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <div class="radio-inline">
                                                                <label role="button">
                                                                    <input type="radio" name="optradio" value="P">Projeto
                                                                </label>
                                                            </div>
                                                            <div class="radio-inline">
                                                                <label role="button">
                                                                    <input type="radio" name="optradio" value="A">Atividade
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <!-- Fim Form -->
                         ...
                         <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Projeto/Atividade do PPA</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/assets/js/pla/ppa_proj_ati/index.js"></script>
