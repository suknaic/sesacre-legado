<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/objetivo/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Objetivos da <?php echo $nomeDiretriz; ?></h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formObjetivo">
                                        <input type="hidden" name="diretriz" id="diretriz" value="<?php echo $idDiretriz; ?>" />
        ...
        <script src="/assets/js/pla/objetivo/index.js"></script>
