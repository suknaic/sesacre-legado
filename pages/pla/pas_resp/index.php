<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/pas_resp/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Registra Permissão Para o Profissional Fazer a Programação Anual de Saúde</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="panel-body">
                                                        <label for="lotacao">
                                                            Unidade/Departamento/Setor: <span class="text-danger">*</span>
                                                        </label>                                                        
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <p class="fa fa-list inputPFa"></p>
                                                            ...
                                                            <select id="lotacao" class="form-control">
                                                                <option value="0">Selecione um Unidade/Departamento/Setor</option>                                                                
                                                                <?php
                                                                    echo $selectLotacao;
                                                                ?>
                                                            </select>
        ...
        <script src="/assets/js/pla/pas_resp/index.js"></script>
