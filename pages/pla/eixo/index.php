<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/eixo/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Eixos do <?php echo $nomePes; ?></h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formEixo">
                                                ...
                                                <div id="form-1" class="tab-pane fade active in">
                                                    <div class="form-group">                                                
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="panel-body">
                                                                <label for="nome">
                                                                    Nome do Eixo: <span class="text-danger">*</span>
                                                                </label>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <span class="input-group-addon text-danger" id="addProjAti" role="button" title="Adicionar Projeto/Atividade do PPA">
                                                                        <p class="fa fa fa-plus inputPFa "></p>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel panel-default">
                                                                <div class="panel-body" style="padding: 9px;">
                                                                    <h4>Lista de Projeto/Atividade do PPA do EIXO</h4>
                                                                </div>                                                               
                                                                
                                                                <table class="table table-striped table-bordered" id="tabelaLista" cellspacing="0" width="100%">
                                                                    <thead>
                                                                        <tr>
                                                                            <td></td><td class="text-center">Remover</td>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>                                                                           
                                                                    </tbody>
        ...
        <script src="/assets/js/pla/eixo/index.js"></script>
