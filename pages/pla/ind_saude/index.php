<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/ind_saude/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Indicador de Saúde</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="radio-inline">
                                                                <label role="button">
                                                                    <input type="radio" name="optradio" value="U">U
                                                                </label>
                                                            </div>
                                                            <div class="radio-inline">
                                                                <label role="button">
                                                                    <input type="radio" name="optradio" value="E">E
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <!-- Fim Form -->
                         ...
                         <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Indicador de Saúde</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/assets/js/pla/ind_saude/index.js"></script>
