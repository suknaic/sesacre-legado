<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/pas/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">PAS - Programação Anual de Saúde</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                            ...
                            <div class="col-sm-12">
                                <div class="panel">
                                    <div class="panel-heading ">
                                        <h3 class="panel-title">Pesquise/Gerencie o PAS</h3>                                        
                                    </div>
                                    ...
                                    <form class="form-horizontal form">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select id="lotacao" class="form-control">
                                                                <option value="0">Selecione uma Área Administrativa/Técnica/Assistencial</option>                                                                
                                                                <?php
                                                                    echo $lotacoes;
                                                                ?>
                                                            </select>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select id="ano" class="form-control">                                                                
                                                                <?php
                                                                    echo Metodos::retornaAnosSelect();
                                                                ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="panel-footer text-right">                                             
                                            <button class="btn btn-primary btn-rounded btn-cad-pas" title="Pas"> 
                                                Elaborar Programação Anual de Saúde
                                            </button>   
                                        </div>
                                        <!-- End Form -->
                                    </form>
        ...
        <script src="/assets/js/pla/pas/index.js"></script>
