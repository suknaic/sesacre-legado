<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/pas/pas_acao_novo.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Cadastro/Gerenciamento de Novas Ações - <?php echo $nomePas; ?></h1>                           
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    <ol class="breadcrumb">
                        <li><a href="pas.php">PAS</a></li>                                                
                        <li><a href="pas_acao.php?token=<?php echo $idPas; ?>" >Voltar</a></li>                           
                    </ol>
                            ...
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <form class="form-horizontal form">                                        
                                        ...
                                        <input type="hidden" name="pes" id="pes" value="<?php echo $idPes; ?>" />
                                                ...
                                                <div id="form-1" class="tab-pane fade active in">  
                                                    <div class="form-group">                                                                                                                                                                                                                              
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel-body">
                                                                <label for="diretriz">
                                                                    Diretriz: <span class="text-danger">*</span>
                                                                </label>                                                        
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                        <p class="fa fa-list inputPFa"></p>
                                                                    </span>
                                                                    <select id="diretriz" class="form-control">    
                                                                        <option value="0">Selecione uma Diretriz</option>                                                                       
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                     ...
                                                                     <input type="text" class="form-control" name="acao" id="acao" required="true">
                                                                </div>
                                                            </div>
                                                        </div>                                                                                                            
                                        ...
                                        <div class="panel-footer text-right">                                                                                           
                                            <a href="pas_acao.php?token=<?php echo $idPas; ?>" class="btn btn-default btn-rounded" title="Voltar"> 
                                                Voltar
                                            </a>
        ...
        <script src="/assets/js/pla/pas/pas_acao_novo.js"></script>
