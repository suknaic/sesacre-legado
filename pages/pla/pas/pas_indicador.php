<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/pas/pas_indicador.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
                            ...
                            <div class="col-sm-12">
                                <div class="panel">
                                    <div class="panel-heading ">
                                        ...
                                        <h3 class="panel-title">Dados - Indicador de Saúde</h3>
                                    </div>
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <select id="indicador" class="form-control">
                                                                        <option value="0">Selecione um Indicador de Saúde</option>                                                                
                                                                        <?php echo $selectIndicador; ?>
                                                                    </select>
                                                                    <span class="input-group-addon text-danger" id="addIndicador" role="button" title="Adicionar Indicador de Saúde">
        ...
        <script src="/assets/js/pla/pas/pas_indicador.js"></script>
