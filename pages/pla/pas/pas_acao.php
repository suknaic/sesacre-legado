<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/pas/pas_acao.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Programação Anual de Saúde - <?php echo $nomePas; ?></h1>                           
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    <ol class="breadcrumb">
                            ...
                            <div class="col-sm-12">
                                <div class="panel">
                                    <div class="panel-heading ">
                                        ...
                                        <h3 class="panel-title">Dados - Ações da PAS</h3>
                                    </div>
                                    ...
                                    <form class="form-horizontal form">                                        
                                                ...
                                                <div id="form-1" class="tab-pane fade active in">  
                                                    <div class="form-group">                                                       
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <select id="proj_ppa_ati" class="form-control">
                                                                        <option value="0">Selecione um Projeto/Atividade do PPA</option>                                                                
                                                                        <?php
                                                                            echo $selectPpaProjAti;
                                                                        ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="panel-body">
                                                                <label for="eixo">
                                                                    Eixo: <span class="text-danger">*</span>
                                                                </label>                                                        
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                        <p class="fa fa-list inputPFa"></p>
                                                        ...
                                                        <div class="col-md-12" >
                                                            <div class="panel-body" id="infoAcao"></div>                                                                                                                        
                                                        </div>
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                     ...
                                                                     <input type="text" class="form-control" name="parceria" id="parceria" required="true">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="panel-body">
                                                                <label for="meta">
                                                                    Meta da Programação: <span class="text-danger">*</span>                                                               </label>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                        <p class="fa fa-file-text-o inputPFa"></p>
                                                                    </span>
                                                                    <input type="text" class="form-control" name="meta" id="meta" required="true">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="panel-body">
                                                                <label for="indicador">
                                                                    Indicador da Programação: <span class="text-danger">*</span>
                                                                </label>
                                                                <div class="input-group">
                                                                        <span class="input-group-addon">
                                                                            <p class="fa fa-file-text-o inputPFa"></p>
                                                                        </span>
                                                                    <input type="text" class="form-control" name="indicador" id="indicador" required="true">
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="panel-footer text-right">                                               
                                            <button class="btn btn-primary btn-rounded btn-nova-acao" type="button">
                                                Casdastrar/Editar Novas Ações
                                            </button>
        ...
        <script src="/assets/js/pla/pas/pas_acao.js"></script>
