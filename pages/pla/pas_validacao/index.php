...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Lista das PAS que estão esperando Autorização Pelo Planejamento</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel-body">
                                                        <span class="text-main text-semibold">
                                                            As Áreas Administrativa/Técnica/Assistencial irão enviar a PAS Para o Planejamento Autorização.<br>
                                                            Essa PAS Enquanto Não estiver Autorizada, ela não está pronta para compor a Pré-LOA, os Relatórios de Valores Planejados pelas Unidades, nenhum outro relátorio que envolva a PAS e etc.<br>
                                                            PAS que forem Liberadas pelo Planejamento para serem alteradas, depois de enviadas também irão aparecer nessa tela para Autorização.<br>
                                                        </span>                                                        
                                                    </div>
                                                </div>                                                                                                
                                            </div>
        ...
        <script src="/assets/js/pla/pas_validacao/index.js"></script>
