<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/pes/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Plano Estadual de Saúde</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formPes">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="panel-body">
                                                        <label for="dt_inicio">
                                                            Início da Vigência: <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                            ...
                                                            <input type="text" class="form-control" name="dt_inicio"
                                                                   id="dt_inicio" placeholder="____" 
                                                                    pattern="\d*" maxlength="4" required="true">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="panel-body">
                                                        <label for="dt_fim">
                                                            Fim da Vigência: <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <p class="fa fa-calendar inputPFa"></p>
                        ...
                        <!-- Fim Form -->
                         ...
                         <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Plano Estadual de Saúde</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/assets/js/pla/pes/index.js"></script>
