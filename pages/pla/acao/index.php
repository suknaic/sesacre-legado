<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/pla/acao/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Ações do <?php echo $nomeObjetivo; ?></h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="../diretriz/index.php?token=<?php echo $idEixo; ?>">Diretriz</a></li>
                        <li><a href="../objetivo/index.php?token=<?php echo $idDiretriz; ?>">Objetivo</a></li>                        
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formAcao">
                                        <input type="hidden" name="objetivo" id="objetivo" value="<?php echo $idObjetivo; ?>" />
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="indicador"
                                                                           id="indicador" pattern="\d*" required="true">
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="meta"
                                                                           id="meta" pattern="\d*" required="true">
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <script src="/assets/js/pla/acao/index.js"></script>
