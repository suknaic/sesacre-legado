                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12 eq-box-md eq-no-panel">
                                <input type="hidden" class="form-control" name="idChamado" id="idChamado" value="<?php if (isset($_GET['id'])) echo $_GET['id']; ?>">
                                <input type="hidden" class="form-control" name="idChamado" id="idChamado" value="">
