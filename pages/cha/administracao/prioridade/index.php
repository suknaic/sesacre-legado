...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Prioridade</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        <form data-toggle="validator" class="form-horizontal" id="form_bloco" role="form" action="#"method="post">
                            <input type="hidden" name="idPrioridade" id="idPrioridade">
                            <div class="panel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            <p class= "form-control-static">Prioridade: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span></p>
                                            <input type="text" class="form-control" name="prioridade" id="prioridade" required="true">
                                            <input type="hidden" name="nmPrioridade" id="nmPrioridade">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            <p class= "form-control-static">Classificação: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span></p>
                                            <select class="form-control" name="classificacao" id="classificacao" title="Selecione uma categoria principal" required="true">
                        ...
                        <div id="page-content">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Lista de Prioridades</h3>
                                </div>
                                <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table id="tabela" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-capitalize text-center">Prioridade</th>
                                                            <th class="text-capitalize text-center">Classificação</th>
        ...
        <script src="/assets/js/cha/administracao/prioridade/index.js"></script>
        <!--Select2-->
