<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/cha/administracao/condicao/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Condição</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        ...
                        <form data-toggle="validator" class="form-horizontal" id="form_bloco" role="form" action="#" method="post">
                            <input type="hidden" name="idStatus" id="idCondicao">
                            <div class="panel">
                        ...
                        <div id="page-content">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Lista de Condições</h3>
                                </div>
                                <div class="panel-body">
        ...
        <script src="/assets/js/cha/administracao/condicao/index.js"></script>
