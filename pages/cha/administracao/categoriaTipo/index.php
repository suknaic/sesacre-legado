...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Categoria Tipo</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        <form data-toggle="validator" class="form-horizontal" id="form_bloco" role="form" action="#"method="post">
                            <input type="hidden" name="idCategoriaTipo" id="idCategoriaTipo">
                            <div class="panel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            ...
                                            <input type="text" class="form-control" name="categoriaTipo" id="nmCategoriaTipo" required="true">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            <p class= "form-control-static">Categoria Principal: <span class="text-danger">*</span></p>
                                            <select class="form-control" name="categoriaPrincipal" id="idCategoriaPrincipal" title="Selecione uma categoria principal" required="true">
                                                <option value="0">Selecione a Categoria Principal</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3"></div>
                        ...
                        <div id="page-content">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Lista de Categorias Tipo</h3>
                                </div>
                                <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table id="tabela" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-capitalize text-center">Categoria Tipo</th>
                                                            <th class="text-capitalize text-center">Categoria Principal</th>
        ...
        <script src="/assets/js/cha/administracao/categoriaTipo/index.js"></script>
        <!--Select2-->
