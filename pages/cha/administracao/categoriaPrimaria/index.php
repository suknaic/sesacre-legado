...
<html lang="pt-br">
    ...
    <body>
                ...
                <div id="content-container">
                    ...
                    <div id="page-content">
                        <form data-toggle="validator" class="form-horizontal" id="form_bloco" role="form" action="#"method="post">
                            <input type="hidden" name="idCategoriaPrimaria" id="idCategoriaPrimaria">
                            <div class="panel">
                        ...
                        <div id="page-content">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Lista de Categorias Primárias</h3>
                                </div>
                                <div class="panel-body">
        ...
        <script src="/assets/js/cha/administracao/categoriaPrimaria/index.js"></script>
        <!--Select2-->
