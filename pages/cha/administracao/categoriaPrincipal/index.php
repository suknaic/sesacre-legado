<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/cha/administracao/categoriaPrincipal/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Categoria Principal</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        ...
                        <form data-toggle="validator" class="form-horizontal" id="form_bloco" role="form" action="#" method="post">
                            <input type="hidden" name="idCategoriaPrincipal" id="idCategoriaPrincipal">
                            <div class="panel">
                        ...
                        <div id="page-content">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Lista de Categorias Principais</h3>
                                </div>
                                <div class="panel-body">
        ...
        <script src="/assets/js/cha/administracao/categoriaPrincipal/index.js"></script>
