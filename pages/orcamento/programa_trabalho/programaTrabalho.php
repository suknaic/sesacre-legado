...
<html lang="pt-br">
    ...
    <body>
                ...
                <div id="content-container">
                    ...
                    <div id="page-content">
                        ...
                        <form data-toggle="validator" class="form-horizontal" id="form_pesquisa" role="form" action="#"method="post">
                            <input type="hidden" name="id_programa_trabalho" id="id_programa_trabalho">    
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Pesquisar Programa Trabalho</h3>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="panel-body">
                                            <p class= "form-control-static">Código: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span></p>
                                            <input type="text" class="form-control" name="codigo" id="codigo" required="true">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="panel-body">
                                            <p class= "form-control-static">Descrição: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span></p>
                                            <input type="text" class="form-control" name="descricao" id="descricao" required="true">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="panel-body">   
                                            <p class= "form-control-static">Ano: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span></p>
        ...
        <script src="/assets/js/orcamento/prog_trab/programa_trabalho.js"></script>
