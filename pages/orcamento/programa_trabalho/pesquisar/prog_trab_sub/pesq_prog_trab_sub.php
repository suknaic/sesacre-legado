...
<html lang="pt-br">
    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div id="page-content"> 
                        ...
                        <form data-toggle="validator" class="form-horizontal" id="form_subfuncao" role="form" action="#" method="post">
                            <input type="hidden" name="id_sub_funcao" id="id_sub_funcao">
                            <div class="panel">                                          
                                <div class="panel-heading">
                                    <h3 class="panel-title">Pesquisar Subfunção</h3>
                                </div>
                                        ...
                                        <div class="col-md-4"></div>
                                            <div class="col-md-4">
                                                <div class="panel-body">
                                                    <p class="form-control-static">Subfunção: <span id="obrigatorio" class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span><span id="informacao" class="text-danger"><i class="glyphicon glyphicon-info-sign"></i> (3 digitos)</span></p>
                                                    <input type="text" class="form-control" rows="7" name="pesq_sub_funcao" id="pesq_sub_funcao" required="true">
                                                </div>
                                            </div>
                                        <div class="col-md-4"></div>
                                    </div>
        ...
        <script src="/assets/js/orcamento/prog_trab/pesquisar/prog_trab_sub/pesq_prog_trab_sub.js"></script>
