...
<html lang="pt-br">
    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div id="page-content"> 
                        ...
                        <!-- Inicio do Formulário de Pesquisa de função-->
                        <form data-toggle="validator" class="form-horizontal" id="form_objeto" role="form" action="#" method="post">
                            ...
                            <div class="panel">                                          
                                <div class="panel-heading">
                                    <h3 class="panel-title">Pesquisar Função</h3>
                                </div>
                                        ...
                                        <div class="col-md-4"></div>
                                            <div class="col-md-4">
                                                <div class="panel-body">
                                                    <p class="form-control-static">Função: <span id="obrigatorio" class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span><span id="informacao" class="text-danger"><i class="glyphicon glyphicon-info-sign"></i> (2 digitos)</span></p>
                                                    <input type="text" class="form-control" rows="7" name="pesq_funcao" id="pesq_funcao" required="true">
                                                </div>
                                            </div>
                                        <div class="col-md-4"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 text-center">
                                        <button type="submit" class="btn btn-success btn-editar btn-rounded" title="Atualizar">
                                            <i class="fa fa-floppy-o" aria-hidden="true"></i> Atualizar
                                        </button>
                                        <button type="submit" class="btn btn-primary btn-pesquisar btn-rounded btn-block" title="Pesquisar">
                        ...
                        <!-- Fim do Formulário de Pesquisa de programa-->
                        <div id="retorno"></div>
                    </div>
                </div>
                <!--===================================================-->
        ...
        <script src="/assets/js/orcamento/prog_trab/pesquisar/prog_trab_func/pesq_prog_trab_func.js"></script>
