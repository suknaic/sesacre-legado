...
<html lang="pt-br">
    ...
    <body>
                        ...
                        <form data-toggle="validator" class="form-horizontal" id="form_programa" role="form" action="#" method="post">                                      
                            <div class="panel">                                          
                                <div class="panel-heading">
                                    <h3 class="panel-title">Cadastro de Programa</h3>
                                </div>
                                        ...
                                        <div class="col-md-4"></div>
                                            <div class="col-md-4">
                                                <div class="panel-body">
                                                    <p class="form-control-static">Programa: <span class="text-danger"><i class="glyphicon glyphicon-info-sign"></i> (4 digitos)</span></p>
                                                    <input type="text" class="form-control" rows="7" name="novo_programa" id="novo_programa" required="true">
                                                </div>
                                            </div>
                                        <div class="col-md-4"></div>
                                    </div>
        ...
        <script src="/assets/js/orcamento/prog_trab/cadastrar/prog_trab_prog/cad_prog_trab_prog.js"></script>
