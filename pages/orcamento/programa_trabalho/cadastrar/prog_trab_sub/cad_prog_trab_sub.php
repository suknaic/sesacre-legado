...
<html lang="pt-br">
    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div id="page-content"> 
                        ...
                        <!-- Inicio do Formulário de Cadastro de programa-->
                        <form data-toggle="validator" class="form-horizontal" id="form_programa" role="form" action="#" method="post">                                      
                            <div class="panel">                                          
                                <div class="panel-heading">
                                    <h3 class="panel-title">Cadastro de SubFunção</h3>
                                </div>
                                        ...
                                        <div class="col-md-4"></div>
                                            <div class="col-md-4">
                                                <div class="panel-body">
                                                    <p class="form-control-static">SubFunção: <span class="text-danger"><i class="glyphicon glyphicon-info-sign"></i> (3 digitos)</span></p>
                                                    <input type="text" class="form-control" rows="7" name="new_sub_funcao" id="new_sub_funcao" required="true">
                                                </div>
                                            </div>
                                        <div class="col-md-4"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 text-center">
                                        <button type="submit" class="btn btn-success btn-salvar btn-block btn-rounded">
                                            <i class="fa fa-floppy-o" aria-hidden="true"></i> Salvar
                                        </button>
                                    </div>
                                    <div class="col-md-1 text-center">
                                        <button type="reset" class="btn btn-default btn-rounded btn-block btn-limpar">
                        ...
                        <!-- Fim do Formulário de Cadastro de programa-->
                    </div>
                </div>
                <!--===================================================-->
        ...
        <script src="/assets/js/orcamento/prog_trab/cadastrar/prog_trab_sub/cad_prog_trab_sub.js"></script>
