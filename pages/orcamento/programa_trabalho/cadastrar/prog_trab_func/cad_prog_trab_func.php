...
<html lang="pt-br">
    ...
    <body>
                            ...
                            <div class="panel">                                          
                                        ...
                                        <div class="col-md-4"></div>
                                            <div class="col-md-4">
                                                <div class="panel-body">
                                                    <p class="form-control-static">Função: <span class="text-danger"><i class="glyphicon glyphicon-info-sign"></i> (2 digitos)</span></p>
                                                    <input type="text" class="form-control" rows="7" name="nova_funcao" id="nova_funcao" required="true">
                                                </div>
                                            </div>
                                        <div class="col-md-4"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 text-center">
                                        <button type="submit" class="btn btn-success btn-salvar btn-rounded btn-block">
                                            <i class="fa fa-floppy-o" aria-hidden="true"></i> Salvar
                                        </button>
                                    </div> 
                                    <div class="col-md-1 text-center">
                                        <button type="reset" class="btn btn-default btn-rounded btn-limpar btn-block">
        ...
        <script src="/assets/js/orcamento/prog_trab/cadastrar/prog_trab_func/cad_prog_trab_func.js"></script>
