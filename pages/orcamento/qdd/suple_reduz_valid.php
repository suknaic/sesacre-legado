<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/orcamento/qdd/suple_reduz_valid.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Validar o Suplementado e Reduzido do QDD <?php echo $ano; ?></h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Caso deseje Validar esse Suplementado/Reduzido, clique no Botão <strong class="text-success">Validar</strong>.</p>
                    ...
                    <div class="modal fade"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Caso deseje NÃO Validar esse Suplementado/Reduzido, clique no Botão <strong class="text-danger">Não Validar</strong>.</p>
                                    <p>Ao Validar essa Ação, o QDD será atualizado de acordo com as informações registradas</p>                                    
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default btn-rounded" data-dismiss="modal">Fechar</button>                                        
        ...
        <script src="/assets/js/orcamento/qdd/suple_reduz_valid.js"></script>
