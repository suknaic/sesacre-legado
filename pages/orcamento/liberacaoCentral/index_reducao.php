...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Lista recurso reduzido da central</h1> 
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                 <div class="panel-footer text-left">
                                    <button class="btn btn-primary btn-rounded btn-novo" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Nova Redução</button>
                                </div>
                                <div class="panel">
        ...
        <script src="/assets/js/orcamento/liberacaoCentral/index_reducao.js"></script>
