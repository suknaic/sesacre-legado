...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Lista Recurso Liberado para Central</h1> 
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                    ...
                                    <form class="form-horizontal formDados">
                                        <div class="form-group">                                              
                                            ...
                                            <div class="col-sm-9">
                                                <div class="panel-body">
                                                    <label for="fonte">
                                                        <?php echo STR_FUNCIONAL_PROGRAMATICA; ?>: 
                                                    </label>                                                        
                                                    <div class="input-group">
                                                        ...
                                                        <select id="projeto" class="form-control select">
                                                            <option value="0">Selecione uma <?php echo STR_FUNCIONAL_PROGRAMATICA; ?></option>                                                                
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script src="/assets/js/orcamento/liberacaoCentral/index.js"></script>
