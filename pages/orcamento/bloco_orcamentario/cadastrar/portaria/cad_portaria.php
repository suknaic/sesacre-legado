<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/orcamento/blocOrcamentario/Portaria_index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Bloco Orçamentário</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        <form data-toggle="validator" class="form-horizontal" id="form_bloco" role="form" action="#"method="post">
                            <input type="hidden" name="id_portaria" id="id_portaria" value="<?php echo $dados['id_portaria'];?>">
                            <div class="panel">
                                <div class="panel-heading">
                                    <?php 
                                        if ($dados == 0){
                                            echo '<h3 class="panel-title">Cadastrar Portaria</h3>';
                                        }else{
                                            echo '<h3 class="panel-title">Editar Portaria</h3>';
                                        }
                                    ?>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            ...
                                            <input type="text" class="form-control" name="portaria" id="portaria" value="<?php echo $dados['nm_portaria'];?>" required="true">
                                            <input type="hidden" name="verifica" id="verifica" value="<?php echo $dados['nm_portaria'];?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            <p class= "form-control-static">Data: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span></p>
                                            <input type="text" class="form-control" name="data" id="data" value="<?php if ($dados != 0){echo Metodos::ConverteDataBR($dados['dt_portaria']);}else{echo $dados['dt_portaria'];}?>" required="true" placeholder="99/99/9999">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            <p class= "form-control-static">Valor Total: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span></p>
                                            <input type="text" class="form-control" name="valor" id="valor" value="<?php if ($dados != 0){echo Metodos::ConverteValorBr($dados['vl_total'],2);}else{echo $dados['vl_total'];}?>" required="true" placeholder="1.000.000,00">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            <input type="hidden" name="id_rede" id="id_rede" value="<?php echo $dados['id_rede_tematica'];?>">
                                ...
                                <?php 
                                    if ($dados == 0){
                                       echo'<div class="col-md-2">
                                        ...
                                        echo'<div class="col-md-2">
                                                <button class="btn btn-success btn-atualizar btn-rounded btn-block" type="button" title="Editar">
                                                    <i class="fa fa-floppy-o" aria-hidden="true"></i> Atualizar
                                                </button>
                                            </div>
                                            <div class="col-md-2">
                                                <button class="btn btn-default btn-cancelar btn-rounded btn-block" type="button" title="Cencelar">
        ...
        <script src="/assets/js/orcamento/bloco_orcamentario/cadastrar/portaria/cad_portaria.js"></script> 
        <!-- END JAVASCRIPT -->
