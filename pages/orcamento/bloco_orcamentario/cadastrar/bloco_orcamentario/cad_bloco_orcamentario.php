...
<html lang="pt-br">
    ...
    <body>
                        ...
                        <form data-toggle="validator" class="form-horizontal" id="form_bloco" role="form" action="#"method="post">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Cadastrar Bloco Orçamentário</h3>
                                </div>
                                <div class="row">
        ...
        <script src="/assets/js/orcamento/bloco_orcamentario/cadastrar/bloco_orcamentario/cad_bloco_orcamentario.js"></script> 
        <!-- END JAVASCRIPT -->
