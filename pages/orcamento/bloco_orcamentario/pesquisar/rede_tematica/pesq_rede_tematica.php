...
<html lang="pt-br">
    ...
    <body>
                ...
                <div id="content-container">
                    ...
                    <div id="page-content">
                        <form data-toggle="validator" class="form-horizontal" id="form_rede_tematica" role="form" action="#"method="post">
                            <input type="hidden" name="id_rede_tematica" id="id_rede_tematica">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Pesquisar Rede Temática</h3>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel-body">
                                            ...
                                            <input type="text" class="form-control" name="rede" id="rede" required="true">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel-body">
        ...
        <script src="/assets/js/orcamento/bloco_orcamentario/pesquisar/rede_tematica/pesq_rede_tematica.js"></script>
