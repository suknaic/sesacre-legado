...
<html lang="pt-br">
    ...
    <body>
                    ...
                    <div id="page-content">
                        <div id="page-content">
                            <form data-toggle="validator" class="form-horizontal" id="form_bloco" role="form" action="#"method="post">
                                <input type="hidden" name="id_bloco_orcamentario" id="id_bloco_orcamentario">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Pesquisar Bloco Orçamentário</h3>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="panel-body">
                                                ...
                                                <input type="text" class="form-control" name="bloco" id="bloco" required="true">
                                            </div>
                                        </div>
                                        <div class="col-md-3"></div>
                                    </div>
                                    <div class="form-group"><br>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <button type="reset" class="btn btn-default btn-rounded btn-cancelar" title="Cancelar">
        ...
        <script src="/assets/js/orcamento/bloco_orcamentario/index.js"></script>
        <!-- END JAVASCRIPT -->
