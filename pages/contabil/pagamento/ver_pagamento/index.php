...
//Modal Alert
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Detalhes do Pagamento</h1> 
                    </div>
                    <ol class="breadcrumb">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="nr_pagamento" id="nr_pagamento" value="<?php echo $dadosPagamento["nr_pagamento"]; ?>" disabled="true"/>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select class="form-control select" name="id_remetente" id="id_remetente" disabled="true">
