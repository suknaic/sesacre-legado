        ...
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Autorização de Anulação de Empenho</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                            ...
                            <form>
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="nr_empenho_anulacao">Número da Anulação do Empenho:</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <p class="fa fa-sort-numeric-asc inputPFa"></p>
                                                    </span>
                                                    <input type="text" id="nr_empenho_anulacao" class="form-control" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="ano_empenho_anulacao">Exercício da Anulação do Empenho:</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <p class="fa fa-list inputPFa"></p>
                                                    </span>
                                                    <select id="ano_empenho_anulacao" class="form-control">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="id_fornecedor">CPF/CNPJ do Fornecedor:</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <p class="fa fa-list inputPFa"></p>
                                                    </span>
                                                    <select id="id_fornecedor" class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="id_central">Central de Demanda:</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <p class="fa fa-list inputPFa"></p>
                                                    </span>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Lista de Anulações de Empenhos</h3>
                        </div>
                        <div class="panel-body">
