        ...
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Liquidação</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <a class="btn btn-rounded btn-primary mar-ver" href="/pages/contabil/liquidacao/cad_liquidacao/" role="button">
                                    <i class="fa fa-plus-circle fa-1x inputPFa"></i>
                                    Cadastrar Liquidação
                                </a>
                            </div>
                            <form>
