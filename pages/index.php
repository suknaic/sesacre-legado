                            ...
                            <div class="col-md-6">
                                <div class="panel">
                                    ...
                                    <div class="" style="height:360px; overflow: auto;">
                                        <div class="" tabindex="0" style="right: -15px; ">
                                            <div class="panel-body bord-btm">
                                                <p class="text-bold text-main text-sm">#68464</p>
                                                <p class="pad-btm">Para conseguir isso, seria necessário ter gramática uniforme, pronúncia e palavras mais comuns. </p>
                                                <a href="#" class="task-footer">
                                                    <span class="box-inline">
                                                        <label class="label label-mint">Solicitação</label>                                                        
                                                        <label class="label label-warning">Recurso</label>
                                                        <label class="label label-danger">Bug</label>
                                                        <label class="label label-primary">Aviso</label>
                                                    </span>
                                                </a>
                                            </div>
                                            <div class="panel-body bord-btm">
                                                <p class="text-bold text-main text-sm">#45684</p>
                                                <p class="pad-btm">Um pequeno rio chamado Duden flui pelo seu lugar e fornece a regelialia necessária. É um país paradisemático, no qual partes assadas de frases entram em sua boca.</p>
                                                <a href="#" class="task-footer">
                                                    <span class="box-inline">
                                                        <label class="label label-dark">Tipo</label>
                                                        <label class="label label-default">Modificação</label>
                                                        <label class="label label-info">Teste</label>
                                                    </span>                                                    
                                                </a>
                                            </div>
                                            <div class="panel-body bord-btm">
                                                 <p class="text-bold text-main text-sm">#84564</p>
                                                 <div class="task-img" style="height: 100px; width: 100px;">
                                                     <img class="img-responsive" src="/assets/img/acrebrasao.jpg" alt="Image">
                                                 </div>
                                                 <p class="pad-btm">Ninguém rejeita, não gosta ou evita o prazer em si, porque é prazer.</p>
                                                 <a href="#" class="task-footer">
                                                     <span class="box-inline">
                                                            <label class="label label-purple">Novo</label>
                                                            <label class="label label-success">Alooo</label>                                                            
                                                     </span>                                                     
                                                 </a>
                                             </div>
                                            ...
                                            <div class="panel-body bord-btm">
                                                ...
                                                <p class="pad-btm">Para dar um exemplo trivial, qual de nós empreende algum exercício físico laborioso, exceto para obter alguma vantagem disso?</p>                                                
                                            </div>
                                            <div class="panel-body bord-btm">
                                                <p class="text-bold text-main text-sm">#45684</p>
                                                <p class="pad-btm">Um pequeno rio chamado Duden flui pelo seu lugar e fornece a regelialia necessária. É um país paradisemático, no qual partes assadas de frases entram em sua boca.</p>                                                
