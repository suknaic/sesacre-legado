<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/compras/itens/cad_item_contrato_ata.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
...
//Modal Alert
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="modelo" id="modelo" value="NÃO TEM"  disabled="true" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="number" name="lote" id="lote"  min="0"  disabled="true" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><p class="fa fa-sort-numeric-asc" style="margin-bottom: -4px"></p></span>
                                                <input class="form-control" type="number" min="0" max="100" name="pc_desconto" id="pc_desconto" value="0" disabled="true">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script src="/assets/js/compras/gestao_contratos/cad_item_contrato_ata.js"></script>
    </body>
</html>
