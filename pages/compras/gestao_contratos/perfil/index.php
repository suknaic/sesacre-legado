<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/compras/contrato/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Permisão contratos</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    <div id="page-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 text-center">
                                        <button  type="button" class="btn btn-success btn-rounded btn-block btn-salvar" title="Salvar">
                                          ...
                                          <button  type="button" class="btn btn-info btn-rounded btn-block btn-editar hidden" title="Salvar">
        ...
        <script src="/assets/js/compras/gestao_contratos/perfil/index.js"></script>
