...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
                    ...
                    <div id="page-content">
                        <div class="panel">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Objetos Desativados</h3>
                            </div>
                            ...
                            <div class="panel-body">
                                <div id="demo-dt-basic_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="tabela_objeto" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
            ...
            <script src="/assets/js/compras/gcon/Objeto/objetosDesativados.js"</script>
