                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="panel-body">
                                                    <p class="form-control-static">Situação: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span>
                                                    <input type="text" class="form-control" name="nova_situacao" id="nova_situacao" placeholder="" required="true">
                                                </div>
                                            </div>
