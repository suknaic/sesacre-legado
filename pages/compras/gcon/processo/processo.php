...
<html lang="pt-br">
    ...
    <body>
                ...
                <div id="content-container">
                    ...
                    <div id="page-content">
                        ...
                        <form data-toggle="validator" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <div class="panel-body">ADA/CPR: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span>
                                            <input type="text" class="form-control" name="ADA_process" id="ADA_process" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="panel-body">N° Pregão:
                                            <input type="numberelivel" class="form-control" name="nume_pregao_process" id="nume_pregao_process" min="1" maxlength="20"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <div class="panel-body">Unidades Contempladas: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span>
                                            <select class="form-control" name="uni_cont_process" id="uni_cont_process" placeholder="">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <div class="panel-body">Valor Total Estimado:
                                            <input class="form-control" type="text" name="valor_process" id="valor_process" placeholder="1.000.000,00">
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel-body">Data: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span>
                                            <input type="text" class="form-control" name="data_process" id="data_process" placeholder="99/99/9999" data-mask="99/99/9999">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel-body">Valor Total Homologado:
                                            <input class="form-control" type="text" name="val_homo_process" id="val_homo_process" placeholder="1.000.000,00">
                                        </div>
                                    </div>
                                    <div class="col-md-3"></div>
                                </div>
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Anotação: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span></h3>
                                </div>
                                <div class="input_ordens">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="panel-body">
                                                <textarea class="form-control" rows="5" name="anotacoes_process" id="anotacoes_process"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Fim do Formulário de Cadastro de Processos-->
                    </div>
                </div>
            </div>
        ...
        <script src="/assets/js/compras/gcon/Processo/processo.js"></script>
        <!-- END JAVASCRIPT -->
    </body>
</html>
