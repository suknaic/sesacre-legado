<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] ."/model/administracao/central_demanda/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        ...
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Manutenção das Centrais de Demanda</h1>                       
                    </div>
                    <ol class="breadcrumb">
...
<!--                                                    <div class="panel-body">-->
                                                    <label for="central_demanda">
                                                        Selecione a Lotação: <span class="text-danger">*</span>
                                                    </label>                                                        
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <p class="fa fa-list inputPFa"></p>
                                                        </span>
                                                        <select id="central_demanda" class="form-control">
...
<!--                        </div>-->
                        <!-- Fim Form -->
                         ...
                         <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Centrais de Demanda</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/assets/js/administracao/central_demanda/index.js"></script>
        <!-- select2 -->
