...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Tipo de Gasto</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Cadastro de Tipo de Gasto</h3>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-3"></div>
                                            <div class="col-md-6">
                                                <div class="panel-body">Nome: <span class="text-danger"><i class="glyphicon glyphicon-asterisk"></i></span>
                                                    <input type="text" class="form-control" name="nm_tipo_gasto" id="nm_tipo_gasto" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-3"></div>
                                        </div>
                                        <div class="panel-footer text-center cadastrar">
                                            <button class="btn btn-success btn-rounded btn-salvar" type="button" title="Salvar">
                                                <i class="fa fa-floppy-o" aria-hidden="true"></i> Salvar
                                            </button>
                                            <button class="btn btn-dark btn-rounded btn-limpar" type="button" title="Limpar">
                                                <i class="glyphicon glyphicon-erase" aria-hidden="true"></i> Limpar
                                            </button>
                                        </div>
                                        <div class="panel-footer text-center atualizar">
                                            <button class="btn btn-success btn-rounded btn-atualizar" type="button" title="Atualizar">
                                                <i class="fa fa-floppy-o" aria-hidden="true"></i> Atualizar
                                            </button>
                                            <button class="btn btn-dark btn-rounded btn-cancelar" type="button" title="Cancelar">
                    ...
                    <div id="page-content">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Lista de Tipos de Gastos</h3>
                            </div>
        ...
        <script src="/assets/js/administracao/tipoGasto/index.js"></script>   
        <!-- END JAVASCRIPT -->
