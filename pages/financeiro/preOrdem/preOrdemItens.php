<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/financeiro/preOrdem/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
...
?>
            <div class="boxed">
                ...
                <div id="content-container">
                    <!--Modal itens content-->
                    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="modalPreOrdem" data-keyboard="false">
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Itens Pré-ordem</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="panel panel-bordered-success">
                                    <div class="panel-body">
                                        ...
                                        <input type="hidden" id="idPreOrdem" value="" />
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="marca" id="marca" disabled="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="modelo" id="modelo" disabled="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="number" name="lote" id="lote" disabled="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><p class="fa fa-sort-numeric-asc" style="margin-bottom: -4px"></p></span>
                                                <input class="form-control" type="text" name="valor_unitario" id="valor_unitario" disabled="true">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button class="btn btn-default btn-info btn-rounded btn-editar hidden" type="button">
        ...
        <script src="/assets/js/financeiro/preOrdem/preOrdemItens.js"></script>
    </body>
</html>
