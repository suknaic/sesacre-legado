            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div id="page-content">
                        ...
                        <div class="col-sm-12">
                            <div class="panel  panelSituacao" style="display: none;">    
                                <div class="panel-heading">
                                    <h3 class="panel-title"></h3>
                                </div>
                                <div class="panel-body">
                                    <div id="graficoSituacao" style="height: 400px"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="panel  panelCentral" style="display: none;">    
                                <div class="panel-heading">
                                    <h3 class="panel-title"></h3>
                                </div>
                                <div class="panel-body">
                                    <div id="graficoCentral" style="height: 400px"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
