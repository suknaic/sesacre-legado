        ...
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">                                                                                                                                 
                    ...
                    <!--===================================================-->                    
                     <div id="page-title">
                        <h1 class="page-header text-overflow">Tela Temporária</h1>                     
                    </div>                    
                    <div id="page-content" class="form-horizontal">
                        
                            <div class="panel">
                                
                                <input type="hidden" id="pedido" value="<?php echo $idPedido ?>" />
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" rows="4" cols="50" name="n_justificativa" id="n_justificativa"><?php echo $justificativa; ?></textarea>                                                        
                                        </div>                                                  
                                    </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-footer text-right">                                   
                                        <button class="btn btn-success btn-salvar btn-rounded">
                                            <i class="fa fa-floppy-o fa-1x"></i> Salvar
                                        </button>                                    
                                    </div>
                                </div>
