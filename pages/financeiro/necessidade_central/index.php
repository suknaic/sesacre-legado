<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/financeiro/necessidade_central/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        ...
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Pedido de necessidade</h1> 
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    <!--Page content-->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel-footer text-left">
                                    <button class="btn btn-primary btn-rounded btn-novo" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Novo Pedido</button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <div class="panel-body">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><p class="fa fa-list" style="margin-bottom: -4px"></p></span>
                                                    <select class="form-control select" name="contratado" id="contratado">
                                        ...
                                        <table id="tabela" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Funcional Programática</th>
    ...
    <script src="/assets/js/financeiro/necessidade_central/index.js"></script>
    <!-- END JAVASCRIPT -->
</body>
</html>
