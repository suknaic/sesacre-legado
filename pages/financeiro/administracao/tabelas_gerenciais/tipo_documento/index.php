        ...
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Cadastro de Tipo de Documento</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                            ...
                            <div class="col-sm-12">
                                    ...
                                    <form class="form">
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="hidden" id="id_tipo_documento" />
                                                    <div class="form-group">
                                                        <label for="nm_tipo_documento">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="nm_tipo_documento" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Lista de Tipos de Documentos</h3>
                                    </div>
                                    <div class="panel-body">
