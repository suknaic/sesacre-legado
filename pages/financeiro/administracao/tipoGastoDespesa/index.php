<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/financeiro/administracao/tipoGastoDespesa/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Cadastrar tipo de gasto e elemento</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                        ...
                        <form data-toggle="validator" class="form-horizontal" id="form_process" role="form" action="#"method="post">
                            <div class="panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel-body">Tipo de gasto:<span class="text-danger"> *</span>
                                            <select class="form-control select" name="tipoGasto" id="tipoGasto">
                                                <option value="0" selected="">Selecione um tipo de gasto</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel-body">Elemento Despesa:<span class="text-danger"> *</span>
                                            <select class="form-control select" name="despesa" id="despesa">
                                                <option value="0" selected="">Selecione um elemento de despesa</option>
                                            ...
                                            <table id="tabela" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">Elemento Despesa</th>
        ...
        <script src="/assets/js/financeiro/administracao/tipoGastoDespesa/index.js"></script>
