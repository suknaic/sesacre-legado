<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/financeiro/autorizacoes/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div id="page-content">
                                    ...
                                    <form class="form-horizontal form">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel-body">
                                                        <label for="tipo_autorizacao">
                                                            Tipo de autorização: <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <p class="fa fa-list inputPFa"></p>
                                                            </span>
                                                            <select id="tipo_autorizacao" class="form-control">
                                                                <option value="0">Selecione o tipo de Autorização</option>
                                                                <?php echo $tipos_autorizacoes ?>
                                                            </select>
                                                        </div>                                                        
                                                    </div>
                                                </div>
                                                <!-- FIM -- Tipo de autorização -- FIM -->
                                                <div class="col-md-6">
                                                    <div class="panel-body">
                                                        <label for="id_pessoa">
                                                            Pessoa Contrato: <span class="text-danger">*</span>
                                                        </label>                                                        
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <p class="fa fa-list inputPFa"></p>
                                                            </span>
                                                            <select id="id_pessoa" class="form-control">
                                                ...
                                                <div class="col-md-6" id="campo_lotacao">
                                                    <div class="panel-body">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="dt_inicio" id="dt_ini" placeholder="__/__/____" required="true">
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Autorizações</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/assets/js/financeiro/autorizacoes/index.js"></script>
        <!-- END JAVASCRIPT -->
