<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/financeiro/autorizacoes/ordenado/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <script src="/assets/js/financeiro/autorizacoes/ordenador/index.js"></script>
        <!-- END JAVASCRIPT -->
