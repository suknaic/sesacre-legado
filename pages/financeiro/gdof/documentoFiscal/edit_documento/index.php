<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/pages/financeiro/gdof/documentoFiscal/edit_documento/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
...
//Modal Alert
                                ...
                                <div class="form-group">
                                    <div  class="col-sm-12" style="margin-bottom: -4%;">
                                        <div class="panel-body empenho">
                                            <?php echo $finDocumentoFiscal->retornaDadosEmpenho(null, false); ?>
                                        </div>
                                    </div>
                                </div>
                                <!--Form das ordens-->
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-5 infoOrdem">
                                                                <table id="tabelaOrdem" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tbody>
                                                                        <?php echo $finDocumentoFiscal->retornaTabelaOrdemGdof(null, true); ?>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="processoAdm" id="processoAdm" 
                                                                           value="<?php echo $documento["nr_processo_administrativo"]; ?>"/>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="nr_documento" id="nr_documento" 
                                                                           value="<?php echo $documento["nr_documento_fiscal"]; ?>"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-7"></div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="emissao" id="emissao" 
                                                                           value="<?php echo Metodos::ConverteDataBR($documento["dt_emissao"]); ?>"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-7"></div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="atesto" id="atesto" 
                                                                           value="<?php echo Metodos::ConverteDataBR($documento["dt_atesto"]); ?>"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-7"></div>
                                                        </div>
        ...
        <script src="/pages/financeiro/gdof/documentoFiscal/edit_documento/index.js"></script>
    </body>
</html>
