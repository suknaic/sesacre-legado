...
function pdf(int $ordem = null, Dados $dadosPdf) {
    ...
    if ($dados != false) {
        ...
        $tabela = '
            ...
            <div class="centro"><b>ORDEM DE EXECUÇÃO/SERVIÇO Nº ' . $dados[0]["nr_ordem"] . '/' . $dados[0]["aa_ordem"] . '</b></div>
            <br/>
             <table>
            <tr>
        ...
        $tabela .= '<br/><b>E-mail:</b> ' . $dados[0]["nm_email"] . '<br/>
        ...
        $tabela .= '<br/><b>Credor Safira nº: </b>' . $dados[0]["nr_safira"] . '<br/>        
