...
<html lang="pt-br">
        ...
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Ordem de entrega</h1> 
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    <!--Page content-->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel-footer text-left">
                                    <button class="btn btn-primary btn-rounded btn-novo" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Nova Ordem</button>
                                </div>
                            </div>
                        </div>
    ...
    <script src="/assets/js/financeiro/ordem/index.js"></script>
    <!-- END JAVASCRIPT -->
</body>
</html>
