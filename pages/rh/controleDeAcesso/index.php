...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Controle de Acesso</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formPessoa">
                                        <div class="panel-body">                                           
                                            <div class="form-group">
                                                <div class="col-sm-2"></div>
                                                <div class="col-sm-4">  
                                                    Pessoa:
                                                    <select class="form-control form-control-md" type="text" name="pessoa" id="pessoa" required="true">

                                                    </select>
                                                </div>
                                                <div class="col-sm-4">
                                                    Perfil:
                                                    <select class="form-control form-control-md" type="text" name="perfil" id="perfil" required="true">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Pessoas e Perfis</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/assets/js/rh/controleDeAcesso/index.js"></script>
        <!-- END JAVASCRIPT -->
