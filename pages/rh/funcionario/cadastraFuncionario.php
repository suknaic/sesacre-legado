        ...
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Cadastro de Funcionário</h1>   
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    <div id="demo-bv-wz">
                                        <div class="tabs wz-heading pad-top" id="myTabs">
                                            <div class="progress progress-xs"><div class="progress-bar progress-bar-primary"></div></div>
                                            <ul class="nav nav-justified row wz-nav-off  wz-icon-bw mar-top wz-steps wz-step">
                                                <li class="active col-xs-3 bv-tab-success"><a href="#tab1" data-toggle="tab"> <span class="title"><b><span class="text-primary">LOGIN</span></b></span></a></li>
                                                <li class="col-xs-3"><a href="#tab2" data-toggle="tab"><span class="title"><b><span class="text-primary">DADOS PESSOAIS</span></b></span></a></li>
                                                <li class="col-xs-3"><a href="#tab3" data-toggle="tab"><span class="title"><b><span class="text-primary">ENDEREÇO / CONTATO</span></b></span></a></li>
                                                <li class="col-xs-3"><a href="#tab4" data-toggle="tab"><span class="title"><b><span class="text-primary">DADOS FUNCIONAIS</span></b></span></a></li>
                                            </ul>
                                        </div><!--end .form-wizard-nav -->
                                        <form id="demo-bv-wz-form" class="form-horizontal formRhFuncionario bv-form" novalidate="novalidate">  
                                            <div class="tab-content clearfix">
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    ...
                                                    <div class="col-md-1"></div>
                                                    <div class="panel-footer col-md-10 panelCompetencia">
                                                        <div class="form-group">
                                                            <div class="col-md-2"></div>
                                                            <div class="col-md-5">
                                                                Competência:
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <select id="id_cargo" class="form-control">
                                                                        <option value="0">Selecione oCargo</option>
                                                                        <?php
                                                                        // echo $lotacoes;
                                                                        ?>
                                                                    </select>
            ...
            <script src="/assets/js/rh/funcionario/cadastroFuncionario.js"></script>
            <!--Datapicker-->
