...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm corpoTodo">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Edição de Funcionário</h1>   
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                    ...
                                    <div class="panel">
                                        <div class="form-wizard-nav">
                                            ...
                                            <ul class="nav nav-justified">
                                                <li class="active"><a href="#tab1" data-toggle="tab"> <span class="title"><b><span class="text-primary">LOGIN</span></b></span></a></li>
                                                ...
                                                <li><a href="#tab4" data-toggle="tab"><span class="title"><b><span class="text-primary">DADOS FUNCIONAIS</span></b></span></a></li>
                                            </ul>
        ...
        <script src="/assets/js/rh/funcionario/editaFuncionario.js"></script>
        <!--Datapicker-->
