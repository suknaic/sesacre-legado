...
$html .= "  <br>          
            <hr>
            <div class='centro'>
                    <b>" . utf8_decode("RELATÓRIO DE FUNCIONÁRIOS POR CARGO") . "</b>
            </div><hr>
                <b>" . utf8_decode("CARGO") . ": " . utf8_decode($rs[0]['nm_cargo']) . "</b><br> <hr>
...
foreach ($rs as $linhas) {
    ...
    if ($idCarg == $linhas['id_cargo']) {
        if ($idLot == $linhas['id_lotacao']) {
            ...
            $html .= "   <tr>
                            <td colspan=3 align='right'><b>" . utf8_decode("Quantidade p/Lotação") . ":
        ...
        $html .= "<tr>
                            <td colspan=3 align='right'><b>" . utf8_decode("Quantidade p/Lotações:") . "<br></td>
                            <td><b>" . $somaQuantLot . "</td>
                 </tr>
            </table>
            <hr>
            <div class='esquerda'><b>" . utf8_decode("Total p/Cargos: </b></div><div class='esquerda'><b>") . $somaQuantCargo . utf8_decode(" Funcionários") . "</b> </div><div class='esquerda'></div>
            <br>
            <hr>";
        ...
        $html .= "
                <hr>
                <b>" . utf8_decode("CARGO") . ": " . utf8_decode($linhas['nm_cargo']) . "</b><br>
                <hr>
                 <b>=> " . utf8_decode("LOTAÇÂO: ") . utf8_decode($linhas['nm_lotacao']) . "</b><br>
                     <table>
                        <tr>
...
$html .= "      <tr>
                            <td colspan=3 align='right'><b>" . utf8_decode(" Quantidade p/Lotação") . "</td>
                            <td><b>" . $somaQuantLot . "</td>
                </tr>
            </table>
            <hr>
            <div class='esquerda'><b>" . utf8_decode("Total p/Cargo: </b></div><div class='esquerda'><b>") . $somaQuantCargo . utf8_decode(" Funcionários") . "</b> </div><div class='esquerda'></div>
            <br>
            <hr>
