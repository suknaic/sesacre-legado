...
//**************************************
$idEmpulo = explode("-", $filtro)[0];
$idLotacao = explode("-", $filtro)[1];
$idEmpo = explode("-", $filtro)[2];
$idFuncao = explode("-", $filtro)[3];
$dataInicio = explode("-", $filtro)[4];
$dataFim = explode("-", $filtro)[5];
//**************************************
$banco = new Contrato();
$rs = $banco->pesquisaRelatorioVinculo($idEmpulo, $idLotacao, $idEmpo, $idFuncao, $dataInicio, $dataFim, 2);
//print_r($rs);
//return FALSE;
if (empty($rs)) {
...
$html .= "  <br>          
            <hr>
            <div class='centro'>
                    <b>RELATÓRIO DE FUNCIONÁRIOS POR EMPRESA</b>
            </div><hr>
                <b>EMPRESA: ".$rs[0]['nm_fantasia']."</b><br> <hr>
...
$idEmp = $rs[0]['id_pessoa_juridica'];
$somaQuantEmpresa = 0;
$somaQuantLot = 0;
$totalGeral = 0;
foreach ($rs as $linhas) {
    $totalGeral ++;
    if ($idEmp == $linhas['id_pessoa_juridica']) {
        if ($idLot == $linhas['id_lotacao']) {
            ...
            $html .= "   <tr>
                            <td colspan=5 align='right'><b>Quantidade p/Lotação:
        ...
        $html .= "<tr>
                            <td colspan=5 align='right'><b>Quantidade p/Lotações:<br></td>
                            <td><b>" . $somaQuantLot . "</td>
                 </tr>
            </table>
            <hr>
            <div class='esquerda'><b>Total p/Empresas: </b></div><div class='esquerda'><b>" . $somaQuantEmpresa . " Funcionários" . "</b> </div><div class='esquerda'></div>
            <br>
            <hr>";
...
$html = $cabecalho;
        $html .= "
                <hr>
                <b>EMPRESA: ".$linhas['nm_fantasia']."</b><br>
                <hr>
                 <b>=>LOTAÇÂO: ".$linhas['nm_lotacao']."</b><br>
                     <table>
                        <tr>
        ...
        $somaQuantEmpresa = 0;
        $idLot = $linhas['id_lotacao'];
        $idEmp = $linhas['id_pessoa_juridica'];
        $somaQuantLot ++;
        $somaQuantEmpresa ++;
...
$html .= "      <tr>
                            <td colspan=5 align='right'><b> Quantidade p/Lotação</td>
                            <td><b>" . $somaQuantLot . "</td>
                </tr>
            </table>
            <hr>
            ...
            <hr>
            <div align='center'><br><br><br>Relatório gerado em " . $dia . " de " . $meses[$mes] . " de " . $ano . " as " . date("H:i:s") . "  
            </div>
           </body>
    </html>";
$mpdf->AddPage();
