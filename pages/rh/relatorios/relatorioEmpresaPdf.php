...
$html .= "  <br>          
            <hr>
            <div class='centro'>
                    <b>" . utf8_decode("RELATÓRIO DE FUNCIONÁRIOS POR EMPRESA") . "</b>
            </div><hr>
                <b>" . utf8_decode("EMPRESA") . ": " . utf8_decode($rs[0]['nm_fantasia']) . "</b><br> <hr>
...
foreach ($rs as $linhas) {
    ...
    if ($idEmp == $linhas['id_pessoa_juridica']) {
        ...
        $html .= "<tr>
            ...
            <hr>
            <div class='esquerda'><b>" . utf8_decode("Total p/Empresas: </b></div><div class='esquerda'><b>") . $somaQuantEmpresa . utf8_decode(" Funcionários") . "</b> </div><div class='esquerda'></div>
            <br>
            <hr>";
...
$html = $cabecalho;
        $html .= "
                <hr>
                <b>" . utf8_decode("EMPRESA") . ": " . utf8_decode($linhas['nm_fantasia']). "</b><br>
                <hr>
                 <b>=> " . utf8_decode("LOTAÇÂO: ") . utf8_decode($linhas['nm_lotacao']) . "</b><br>
                     <table>
                        <tr>
