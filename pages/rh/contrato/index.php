...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Cadastrar Novo Contrato</h1>                       
                    </div>
                    <!--End page title-->
                    <!--Page content-->
                    <!--===================================================-->
                                    ...
                                    <div class="panel-footer">
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <label>
                                                        CPF: <span class="text-danger">*</span> <i class="fa fa-question-circle" title="Informe o CPF da Pessoa Física"></i>
                                                    </label>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <p class="fa fa-file-text-o inputPFa"></p>
                                                        </span>
                                                        <input type="text" class="form-control cpf" name="nr_cpf" id="nr_cpf" placeholder="___.___.___-__" required="true">
                                                    </div>
                                                </div>
                                            </div>                                                
                                            <div align="center">
        ...
        <script src="/assets/js/rh/contrato/index.js"></script>
        <!--Datapicker-->
