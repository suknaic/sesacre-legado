...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Lotação Detalhe</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                ...
                                <div class="panel">
                                    <div class="panel-footer text-left">
                                        <button class="btn btn-primary btn-rounded btn-novo" type="button">
                                            <i class="fa fa-plus" aria-hidden="true"></i> Nova Lotação Detalhe
                                        </button>
                                    </div>
        ...
        <script src="/assets/js/rh/lotacaoDetalhe/index.js"></script>
        <!--Datapicker-->
