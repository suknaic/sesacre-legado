...
<html lang="pt-br">
    <head>
        ...
        <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Edição de Lotação</h1>   
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    <?php
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form class="form-horizontal formRhLotacao">  
                                    ...
                                    <input type="hidden" class="form-control" name="id_lotacao" id="id_lotacao" value="">
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    Categoria: <span class="text-danger"> * </span><i class="fa fa-question-circle" title="Informe a Categoria da Lotação"></i>
        ...
        <script src="/assets/js/rh/lotacaoDetalhe/editaLotacaoDetalhe.js"></script>
        <!--Datapicker-->
