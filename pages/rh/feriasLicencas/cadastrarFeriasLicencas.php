...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            ?>
            <div id="modalContratoHistorico" class="modal fade modalContratoHistorico" role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">    
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div id="modal-corpo"class="modal-body">
                            <input type="hidden"  id="id_contrato_historico" name="id_contrato_historico" value="" />
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 dataPre_editar">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow titulo">Cadastrar Férias, Licenças e Concessões</h1>                       
                    </div>
                    <!--End page title-->
                    <!--Page content-->
                    <!--===================================================-->
                                        ...
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea class="form-control" name="ds_observacao" id="ds_observacao" rows="4"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div align="center">
                                                <button class="btn btn-success btn-rounded btn-salvar" type="button">
                                                    <i class="fa fa-floppy-o" aria-hidden="true"></i> Salvar Situação
                                                </button>
                                            </div>
