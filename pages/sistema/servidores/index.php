<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/pages/sistema/servidores/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Servidores</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                            ...
                            <div class="col-sm-12">
                                <div class="panel">
                                    <div class="panel-footer text-left">
                                        <button class="btn btn-primary btn-rounded btn-novoServidor" type="button">
                                            <i class="fa fa-plus" aria-hidden="true"></i> Novo Servidor
                                        </button>
                                    </div>
                                    <div class="panel-heading ">
                                        <h3 class="panel-title">Pesquisa de Servidores</h3>
                                    </div>

                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formPesquisaServidor">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="nm_servidor" id="nm_servidor" required="true">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="cpf_servidor" id="cpf_servidor" placeholder="___.___.___-__" required="true">
                                                    </div>
                                                </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Lista de Servidores</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/pages/sistema/servidores/index.js"></script>
        <!--Datapicker-->
