...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Edição de Pessoa Jurídica</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel">
                                    <div id="demo-bv-wz">
                                        ...
                                        <form id="demo-bv-wz-form" class="form-horizontal bv-form formPessoaJuridica" novalidate="novalidate">
                                            <input type="hidden" class="form-control" name="id_get" id="id_get" value="<?php if (isset($_GET['id'])) echo $_GET['id']; ?>">
                                            <input type="hidden" id="id_pessoa" name="id_pessoa" value="">
                                            <input type="hidden" id="id_pessoa_juridica" name="id_pessoa_juridica" value="">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="demo-bv-tab2" class="tab-pane fade">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-1"> </div>
                                                            <div class="col-md-6">
                                                                Natureza: <span class="text-danger">*</span>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control data" name="dt_fundacao" id="dt_fundacao" placeholder="__/__/____" pattern="\d*" maxlength="4" required="true">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="nr_cnae" id="nr_cnae" placeholder="____-_/__" required="true">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Nro. SAFIRA:
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="nr_safira" id="nr_safira">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="ds_insc_estadual" id="ds_insc_estadual" required="true">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                Inscrição Municipal:
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="ds_insc_municipal" id="ds_insc_municipal" required="true">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="panel-footer text-right">
                                                ...
                                                <button type="button" class="btn btn-success btn-info btn-rounded btn-salvar">
        ...
        <script src="/assets/js/sistema/pessoa/editaPessoaJuridica.js"></script>
        <!--Datapicker-->
