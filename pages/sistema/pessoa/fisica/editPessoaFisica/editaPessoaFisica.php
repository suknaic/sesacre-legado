...
<html lang="pt-br">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-sm">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Edição de Pessoa Física</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                ...
                                <div class="panel">
                                    <div id="demo-bv-wz">
                                        ...
                                        <form id="demo-bv-wz-form" class="form-horizontal bv-form formRhFuncionario" novalidate="novalidate">
                                            ...
                                            <input type="hidden" id="id_pessoa_fisica" name="id_pessoa_fisica" value="">
        ...
        <script src="/assets/js/sistema/pessoa/editaPessoaFisica.js"></script>
        <!--Datapicker-->
