<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/sistema/vinculo/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Vínculos</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                                    ...
                                    <form class="form-horizontal formVinculo">
                                        <div class="panel-body">                                           
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    Nome do Vínculo: <span class="text-danger">*</span>
                                                    <input type="text" placeholder="Nome do Vínculo" id="nmVinculo" class="form-control" required autofocus>
                                                </div>
                                            </div>                                                                                     
                                        </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Lista de Vínculos</h3>
                            </div>
                            <div class="panel-body">
        ...
        <script src="/assets/js/sistema/vinculo/index.js"></script>
