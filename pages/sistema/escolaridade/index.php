<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/sistema/escolaridade/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        ...
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Grau de Escolaridade</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                    ...
                                    <form class="form-horizontal formVinculo">
                                        <div class="panel-body">                                           
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    Grau de escolaridade: <span class="text-danger">*</span>
                                                    <input type="text" placeholder="Grau de Escolaridade" id="nmEscolaridade" class="form-control" required autofocus>
                                                </div>
                                            </div>                                                                                     
                                        </div>
