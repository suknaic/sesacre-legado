<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/sistema/formacao/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel">
                                    ...
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                    <form class="form-horizontal formFormacao">
                                        ...
                                        <div class="panel-footer text-right">
                                            ...
                                            <button class="btn btn-success btn-rounded btn-salvar" type="button" style="display: none;">
