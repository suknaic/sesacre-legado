<!DOCTYPE html>
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/model/sistema/funcao/index.load.php";
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Função</h1>                       
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                    ...
                                    <form class="form-horizontal formVinculo">
                                        <div class="panel-body">                                           
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    Nome da Função: <span class="text-danger">*</span>
                                                    <input type="text" placeholder="Nome da Funcão" id="nm_funcao" class="form-control" required autofocus>
                                                </div>
                                            </div>                                                                                     
                                        </div>
        ...
        <script src="/assets/js/sistema/funcao/index.js"></script>
