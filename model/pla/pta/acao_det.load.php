...
//Token referente ao id do PTA Ação, caso não tenha irá direto para o index
...
$ptaAcao = new PasAcao();
$ptaAcao->setIdPpaProjAti($ptaTitulo->getIdPpaProjAti());
$ptaAcao->setIdPas($ptaTitulo->getIdPas());
$optionAcao = $ptaAcao->retornaOptionAcaoPorPpaProjAti($pdo);
