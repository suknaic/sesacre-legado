...
$pasAcao = new PasAcao();
$pasAcao->setIdPas($pas->getIdPas());

$selectAcao = $pasAcao->retornaSelectPorPas();

$ind = new IndicadorSaude();

$dataPas = new DateTime($pas->getDtInicio());

$selectIndicador = $ind->retornaSelectPorAno($dataPas->format("Y"));
