...
class DocFiscalRecebimento {
    ...
    private function condicoes() {
        try {
            ...
            $condicoes[] = array('LOT.id_lotacao', '=', $this->getDestinatario(),'int');
            $condicoes[] = array('REC.id_pessoa', '=', $this->getIdUsuario(),'int');
            $condicoes[] = array('TRM.id_tipo_tramitacao','=', 4,'int'); //Aguardando Recebimento
