...
require_once $_SERVER['DOCUMENT_ROOT'] . "/class/tabelas/compras/FinContratoInstrumentoTb.class.php";

class DaoFinContratoInstrumento extends FinContratoInstrumentoTb {
...
//    }   
    ...
    function retornaTodos($pdo) {    
        ...
        $sql = " SELECT id_contrato_instrumento, nm_contrato_instrumento"                    
                . " FROM fin_contrato_instrumento"
                . " WHERE st_ativo = '1'";
        try {
