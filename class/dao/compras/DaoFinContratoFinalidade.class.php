...
require_once $_SERVER['DOCUMENT_ROOT'] . "/class/tabelas/compras/FinContratoFinalidadeTb.class.php";

class DaoFinContratoFinalidade extends FinContratoFinalidadeTb {
...
//    }   
    ...
    function retornaTodos($pdo) {
        ...
        $sql = " SELECT id_contrato_finalidade, nm_contrato_finalidade"                    
                . " FROM fin_contrato_finalidade"
                . " WHERE st_ativo = '1'";
        try {
