...
require_once $_SERVER['DOCUMENT_ROOT'] . "/class/tabelas/compras/FinContratoAquisicaoTb.class.php";

class DaoFinContratoAquisicao extends FinContratoAquisicaoTb {
...
//    }   
    ...
    function retornaTodos($pdo) {
        ...
        $sql = " SELECT id_contrato_aquisicao, nm_contrato_aquisicao"                    
                . " FROM fin_contrato_aquisicao"
                . " WHERE st_ativo = '1'";
        try {
