...
require_once $_SERVER['DOCUMENT_ROOT'] . "/class/tabelas/compras/FinContratoUnidadeCalculoTb.class.php";

class DaoFinContratoUnidadeCalculo extends FinContratoUnidadeCalculoTb {
...
//    }   
    ...
    function retornaTodos($pdo) {
        ...
        $sql = " SELECT id_contrato_unidade_calculo, nm_contrato_unidade_calculo"                    
                . " FROM fin_contrato_unidade_calculo"
                . " WHERE st_ativo = '1'";
        try {
